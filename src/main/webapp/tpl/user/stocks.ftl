...
<td align="center" width="22%">
<a class="f_black" href="/stock/user/stockInfo" target="_blank">查看新闻推送页</a>
</td>
...
<table id="tablesorter-demo" class="tablesorter" width="100%"  border="0" cellpadding="0" cellspacing="1"> 
	...
	<tbody>
		<#if list ??>
			<#list list as l>
				<tr>
					<td width="3.5%" align="center"><a class="f_black" href="#" onclick="delStock('${l.code}')">删</a></td>
